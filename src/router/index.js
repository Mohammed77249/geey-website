...
const routes = [
  ...
  // Phone routes
  {
    ...
    children: [
      ...
      { path: 'user/setting', name: 'phoneSetting', component: () => import('@/views/phone/user/settings/SettingPage.vue'),meta: { requiresAuth: false, showFooter:false ,showHeader:false  } },
