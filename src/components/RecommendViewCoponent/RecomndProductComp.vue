...
<template>
  <div class="mx-auto pl-2 pr-2 ">
    ...
    <div class="cursor-pointe w-[full] h-[350px] " @mouseenter="onhover(product.id)" @mouseleave="isHover = false"  >
      ...
      <img :src="hoverId === product.id && isHover ? product.images[0] : product.images[1] " alt="no image" class="w-full h-full object-cover transition duration-300 ease-in-out" />
