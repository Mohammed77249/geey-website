  ...
  <div class="relative max-w-lg mx-auto p-2">
    ...
    <div class="flex items-center  overflow-hidden">
      <input
        ...
        @input="handleSearch"
        type="text"
       class="w-full pr-10 pl-4 py-1 md:py-2 text-gray-700 border border-primary-900 bg-[#F6F6F6] focus:outline-none focus:border-gray-900 "
        :placeholder="$t('Search for products...')"
      />
      <button
        @click="handleSearch"
        class="px-2  w-10 text-gray-400 py-1 md:py-2 cursor-pointer bg-primary-900  transition"
      >
            <svg
              width="25"
              height="25"
