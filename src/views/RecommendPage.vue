          ...
          <div class="space-y-10">
            ...
            <div>
              <div class="flex items-center justify-between">
                ...
                <button
                  type="button"
                  @click="
                    isDropdowenResourccesVisable = !isDropdowenResourccesVisable
                  "
                >
                  <svg
                    v-if="!isDropdowenResourccesVisable"
                    width="15"
                    height="15"
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <ResourccesComp
                :isDropdowenVisable="isDropdowenResourccesVisable"
                :resorcces="resorcces"
              />
              <div></div>
            </div>
            ...
            <div>
              <div class="flex items-center justify-between">
                ...
                <button
                  type="button"
                  @click="
                    isDropdowenDesignesVisable = !isDropdowenDesignesVisable
                  "
                >
                  <svg
                    v-if="!isDropdowenDesignesVisable"
                    width="15"
                    height="15"
                    viewBox="0 0 24 24"
                    fill="none"
            ...
            <div>
              <div class="flex items-center justify-between">
                ...
                <button
                  type="button"
                  @click="isDropdowenTypesVisable = !isDropdowenTypesVisable"
                >
                  <svg
                    v-if="!isDropdowenTypesVisable"
                    width="15"
                    height="15"
                    viewBox="0 0 24 24"
                    fill="none"
            ...
            <div>
              <div class="flex items-center justify-between">
                ...
                <button
                  type="button"
                  @click="isDropdowenTallVisable = !isDropdowenTallVisable"
                >
                  <svg
                    v-if="!isDropdowenTallVisable"
                    width="15"
                    height="15"
                    viewBox="0 0 24 24"
                    fill="none"
            ...
            <div>
              <div class="flex items-center justify-between">
                ...
                <button
                  type="button"
                  @click="
                    isDropdowenAdvantageVisable = !isDropdowenAdvantageVisable
                  "
                >
                  <svg
                    v-if="!isDropdowenAdvantageVisable"
                    width="15"
                    height="15"
                    viewBox="0 0 24 24"
                    fill="none"
        ...
        <div class="mt-16">
          <div class="flex gap-5">
            <div ref="dropDownStatus">
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      class="flex items-center ps-2 rounded hover:bg-gray-100"
                    >
                      <span
            ...
            <!-- <div>
              <button
                type="button"
                class="bg-gray-50 h-[40px] w-[100px] hover:bg-gray-100"
              >
...
const statuses = [
  ...
  'الوصول الجديد',
  'الاعلى تقييما',
  'السعر من الاقل الى الاكثر',
  'السعر من الاكثر الى الاقل',
]
